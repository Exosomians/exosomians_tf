...
arguments_group.add_argument('-d', '--dropout_rate', type=float, default=0.4, required=False,
                             help='Dropout rate')
arguments_group.add_argument('-w', '--weight', type=float, default=10.0, required=False,
...
# Subsampling
merged_sequences_no = merged_sequences[labels == 0]
merged_sequences_yes = merged_sequences[labels == 1]
...
merged_sequences = np.concatenate([merged_sequences_no, merged_sequences_yes], axis=0)
