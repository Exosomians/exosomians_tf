...
class ExoLSTM(Network):
    ...
    def _create_network(self):
        h = LSTM(16, return_sequences=True, kernel_initializer=self.init_w, kernel_regularizer=self.regularizer)(
            self.sequence)
        ...
        h = LSTM(16, return_sequences=False, kernel_initializer=self.init_w, kernel_regularizer=self.regularizer)(
            h)
        if self.use_batchnorm:
            h = BatchNormalization()(h)
        h = LeakyReLU()(h)
